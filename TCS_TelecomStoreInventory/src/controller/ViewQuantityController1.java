...
/**
 * Servlet implementation class ViewQuantityController1
 */
public class ViewQuantityController1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewQuantityController1() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("viewQuantity.jsp").forward(request, response);
