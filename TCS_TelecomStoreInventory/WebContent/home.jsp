...
<!-- end #menu -->
	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				<h3 class="title"><a href="#">Welcome to Inventory   </a></h3><br/><br/><br/><br/>
				
				<div class="entry" style="font-size:15px">
				 <p>This is <strong>InventoryModule 2: Product, Stock, and Sales Promotion  </strong> <br/><br/>
      a) Product Models  <br/> <br/> 
      b) Stock<br/><br/>
      c) Product Sales Promotion<br/>
