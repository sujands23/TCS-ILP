...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="retailer.jsp">Retailer</a></li>
	...
	<div id="sidebar">
			<ul>
				<li>
					...
					<h3><center>Retailer Menu</center></h3>
					</form>
					</div>
		...
		<div id="content">
			<div class="post">
				...
				<div class="entry" style="font-size:15px">
					...
					<br/>
					<br/>
					<p>This is <strong>Inventory  </strong> a fully standards-compliant management system for 
					Sed lacus Proin imperdiet est. Phasellus dapibus semper urna. Pellentesque ornare, orci in f</p>
