...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="viewProductRetailer.jsp">Product</a></li>
			
			<li><a href="viewPackageRetailer.jsp">Packages</a></li>
	...
	<div id="sidebar">
				...
				<h3>Product Menu</h3>
					...
					<div style="clear: both;">&nbsp;</div>
			          ...
			          <center><ul>
                  			   ...
                  			   <li><a href="viewProductRetailer.jsp">View Product</a></li>
			...
			%>	
				...
				<form  name="input"  action="ViewProductModelController1" method="post" onsubmit ="return validate()"  ><BR><BR>
